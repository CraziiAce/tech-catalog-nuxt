<template>
  <!-- <figure class="rounded-xl border-4 m-12 p-2 lg:w-1/4 md:w-1/3 sm:w-2/3"> -->
  <figure class="rounded-xl border-4 w-auto">
    <a :href="id_url"></a>
    ...
    <div class="w-full h-full">
      <img :src="img" :alt="name" class="w-auto h-auto max-w-xs align-center" />
    </div>
  </figure>
</template>
<script>
